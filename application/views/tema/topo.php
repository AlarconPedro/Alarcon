...
<head>
  <title><?= $configuration['app_name'] ?: 'OSxpress' ?></title>
  <meta charset="UTF-8" />
...
<body>
  <!--Header-part-->
  <div id="header">
    <h1><a href=""> <?= $configuration['app_name'] ?: 'OSxpress' ?> </a></h1>
  </div>
  <!--close-Header-part-->
  <!--top-Header-menu-->
  <div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
      ...
      <li class="pull-right"><a href="https://github.com/AlarconPedro/TCC-V2.0" target="_blank"><i class="fas fa-asterisk"></i> <span class="text">Versão:
